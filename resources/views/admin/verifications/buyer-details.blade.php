    ...
    <div class="flex flex-1 bg-gray-50">
        ...
        <div class="flex-1 overflow-auto">
            ...
            @include('layouts.nav.content-header', [
                ...
                'subtitle' => 'Review buyer details and approve for platform access',
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <div class="border border-gray-200 rounded-lg p-4">
                                @if(!$user->is_verified)
                                <div class="mb-4">
                                    <h4 class="text-md font-medium text-gray-800 mb-2">Buyer Approval</h4>
                                    <p class="text-sm text-gray-600 mb-4">Approve this buyer to allow them to message sellers and request quotes.</p>
                                    
                                    <div class="flex space-x-3">
                                        <form method="POST" action="{{ route('admin.verifications.users.buyer.approve', $user) }}">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit" 
                                        ...
                                        <form method="POST" action="{{ route('admin.verifications.users.buyer.reject', $user) }}">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit" 
                                ...
                                @else
                                <div class="mb-4">
                                    <h4 class="text-md font-medium text-gray-800 mb-2">Buyer Approved</h4>
                                    <p class="text-sm text-gray-600 mb-4">This buyer has been approved and can message sellers and request quotes.</p>
                                    ...
                                    <form method="POST" action="{{ route('admin.verifications.users.buyer.reject', $user) }}">
                                        ...
                                        <button type="submit" 
                                                class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-sm text-red-700 bg-white hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                                                onclick="return confirm('Are you sure you want to reject this buyer? This will remove their ability to message sellers.')">
                                            <svg class="-ml-1 mr-2 h-5 w-5 text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd" />
                                            </svg>
                                            Reject Buyer
