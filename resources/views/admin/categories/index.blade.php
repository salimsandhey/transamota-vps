                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <form method="GET" class="flex gap-2">
                                ...
                                @if(request()->has('search'))
                                    <a href="{{ route('admin.categories.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg text-sm hover:bg-gray-300">
                                        Clear
                                    </a>
                                @endif
                            </form>
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="py-4">
                                        <a href="{{ route('admin.categories.products', $category) }}" class="text-blue-600 hover:text-blue-800">
                                            {{ $category->products_count }} products
                                        </a>
                                    </td>
                                    <td class="py-4">
                                        <a href="{{ route('admin.categories.subcategories.index', $category) }}" class="text-blue-600 hover:text-blue-800">
