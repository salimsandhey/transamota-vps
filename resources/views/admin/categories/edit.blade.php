                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    <div class="flex items-center mb-2">
                                        <input type="radio" id="predefined-icons" name="icon-type" value="predefined" class="mr-2" {{ empty(old('icon', $category->icon)) || strpos(old('icon', $category->icon), 'data-svg') !== false ? 'checked' : '' }}>
                                        <label for="predefined-icons" class="text-sm text-gray-700">Select from predefined icons</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input type="radio" id="custom-icon" name="icon-type" value="custom" class="mr-2" {{ !empty(old('icon', $category->icon)) && strpos(old('icon', $category->icon), 'data-svg') === false ? 'checked' : '' }}>
                                        <label for="custom-icon" class="text-sm text-gray-700">Enter custom SVG code</label>
                                    </div>
                                </div>
                                
                                <!-- Predefined Icons Section -->
                                <div id="predefined-icons-section" class="mb-4 {{ !empty(old('icon', $category->icon)) && strpos(old('icon', $category->icon), 'data-svg') === false ? 'hidden' : '' }}">
                                ...
                                <!-- Custom Icon Section -->
                                <div id="custom-icon-section" class=" {{ !empty(old('icon', $category->icon)) && strpos(old('icon', $category->icon), 'data-svg') === false ? '' : 'hidden' }}">
                                    <textarea 
                                        id="icon" 
                                        name="icon" 
                                        rows="3"
                                        ...
                                        placeholder="Enter SVG icon code">{{ old('icon', $category->icon) }}</textarea>
                                    <p class="mt-1 text-xs text-gray-500">Enter SVG code for the category icon (e.g., &lt;svg&gt;...&lt;/svg&gt;)</p>
                                </div>
                                
                                <!-- Hidden input to store selected icon -->
                                <input type="hidden" id="selected-icon" name="icon" value="{{ old('icon', $category->icon) }}">
