...
<div class="flex flex-col min-h-screen">
    <div class="flex flex-1 bg-gray-50">
        ...
        <div class="flex-1 overflow-auto">
            <div class="p-8">
                <div class="mb-6">
                    <a href="{{ route('admin.contact-messages.index') }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 mb-4">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6">
                    <div class="flex justify-between items-start mb-6">
                        <div>
                            ...
                            <div class="flex items-center mt-2 text-sm text-gray-600">
                                <span class="mr-4">From: {{ $contactMessage->name }}</span>
                                <span>{{ $contactMessage->email }}</span>
                            </div>
                        </div>
                        <span class="px-3 py-1 {{ $contactMessage->is_read ? 'bg-green-100 text-green-800' : 'bg-amber-100 text-amber-800' }} text-sm rounded-full">
                    ...
                    <div class="border-t border-gray-200 pt-6 mt-6 flex justify-between items-center">
                        <div class="text-sm text-gray-500">
                            Sent on {{ $contactMessage->created_at->format('F j, Y \a\t g:i A') }}
                        </div>
