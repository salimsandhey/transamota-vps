    ...
    <div class="lg:col-span-1 bg-white rounded-xl border border-gray-200 p-6">
        <div class="text-center">
            <div class="mx-auto w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mb-4">
                <span class="text-green-600 font-bold text-2xl">{{ substr(Auth::user()->name, 0, 1) }}</span>
            </div>
        ...
        <div class="mt-6">
            <a href="{{ route('seller.profile.personal-info') }}" class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50">
                Edit Profile
            </a>
        </div>
    </div>
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <a href="{{ route('seller.profile.personal-info') }}" class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center">
                ...
                <a href="{{ route('seller.profile.business-info') }}" class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center">
                ...
                <a href="{{ route('seller.profile.documents') }}" class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center">
                ...
                <a href="{{ route('seller.profile.settings') }}" class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div class="flex items-center">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div class="mt-4">
                <a href="{{ route('seller.profile.documents') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                    Upload Documents
                </a>
            </div>
        </div>
