<!-- Seller Public Header - Public Header without Categories -->
<header class="bg-white shadow-sm sticky top-0 z-50 mobile-header">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center text-sm">
                <div class="flex space-x-6">
                    <a href="{{ route('products.browse') }}" class="text-gray-600 hover:text-blue-600 hidden md:inline">Browse Products</a>
    ...
    <div id="mobile-menu" class="md:hidden hidden">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
            ...
            <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-50">Help Center</a>
            
            @auth
                <div class="pt-4 pb-2 border-t border-gray-200">
                    <div class="px-3 py-2 text-sm text-gray-700">Welcome, {{ Auth::user()->name }}!</div>
                    <a href="{{ route('products.browse') }}" class="block w-full text-left px-4 py-2 text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-50">Browse Products</a>
