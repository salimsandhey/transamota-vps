// JavaScript for collapsible seller sidebar functionality
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const textElements = [
        ...
        document.getElementById('customers-text'),
        document.getElementById('analytics-text'),
        document.getElementById('payments-text'),
    ...
    window.addEventListener('resize', function() {
        if (window.innerWidth < 768) { // Mobile
            // Only apply mobile styles if sidebar is not open
    ...
    if (window.innerWidth < 768) {
        ...
        // Ensure no margin classes on initial load for desktop
        const isCollapsed = localStorage.getItem('sidebarCollapsed') === 'true';
        if (isCollapsed) {
            collapseSidebar();
        } else {
