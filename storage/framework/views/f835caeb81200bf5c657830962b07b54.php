                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="email" id="admin_email" name="admin_email" value="<?php echo e(old('admin_email', $adminEmail)); ?>" required
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/transamota.com/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>