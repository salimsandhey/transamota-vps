<?php $__env->startSection('title', 'Safety Tips - Transamota'); ?>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="prose prose-lg max-w-none">
                    ...
                    <div class="bg-blue-50 rounded-lg border border-blue-200 p-6 mt-12">
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                            Contact Support
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/transamota.com/resources/views/safety-tips.blade.php ENDPATH**/ ?>