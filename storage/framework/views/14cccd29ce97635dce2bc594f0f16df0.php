<?php $__env->startSection('title', 'Login - Transamota'); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-5">
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-blue-600 hover:text-blue-800">Forgot password?</a>
                        </div>
                        <div class="relative">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6 text-center text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="text-blue-600 hover:text-blue-800 font-medium">Register now</a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/transamota.com/resources/views/auth/login.blade.php ENDPATH**/ ?>