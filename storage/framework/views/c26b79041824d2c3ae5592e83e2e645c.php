<?php $__env->startSection('title', 'Sell on Transamota - Reach Global Buyers'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl p-12 text-center text-white">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="<?php echo e(route('register')); ?>?type=seller" class="px-8 py-4 bg-white text-blue-600 rounded-lg font-bold hover:bg-gray-100 transition-colors">
                        Register as Seller
                    </a>
                    <a href="<?php echo e(route('how-to-sell')); ?>" class="px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-bold hover:bg-white hover:text-blue-600 transition-colors">
                        Learn How to Sell
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/transamota.com/resources/views/sell.blade.php ENDPATH**/ ?>