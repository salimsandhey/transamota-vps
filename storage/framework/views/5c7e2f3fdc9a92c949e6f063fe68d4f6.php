                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <form method="GET" class="flex gap-2">
                                ...
                                <?php if(request()->has('search') || request()->has('role')): ?>
                                    <a href="<?php echo e(route('admin.users.index')); ?>" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg text-sm hover:bg-gray-300">
                                        Clear
                                    </a>
                                <?php endif; ?>
                            </form>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="py-4">
                                        <?php if($user->role == 'seller'): ?>
                                            <span class="px-2 py-1 text-xs rounded-full 
                                                <?php if($user->profile && $user->profile->verified_by_admin): ?> bg-green-100 text-green-800 
                                                <?php else: ?> bg-yellow-100 text-yellow-800 <?php endif; ?>">
                                                <?php if($user->profile && $user->profile->verified_by_admin): ?> Verified <?php else: ?> Unverified <?php endif; ?>
                                            </span>
                                        <?php elseif($user->role == 'buyer'): ?>
                                            <span class="px-2 py-1 text-xs rounded-full 
                                                <?php if($user->is_verified): ?> bg-green-100 text-green-800 <?php else: ?> bg-yellow-100 text-yellow-800 <?php endif; ?>">
                                                <?php if($user->is_verified): ?> Verified <?php else: ?> Unverified <?php endif; ?>
                                            </span>
                                        <?php else: ?>
                                    ...
                                    <td class="py-4 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <?php if($user->role == 'seller'): ?>
                                                ...
                                                <?php if($user->profile && $user->profile->verification_doc): ?>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <form method="POST" action="<?php echo e(route('admin.users.verify', $user)); ?>" class="inline">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PATCH'); ?>
                                                    <button type="submit" 
                                                            class="text-<?php echo e($user->is_verified ? 'yellow' : 'green'); ?>-600 hover:text-<?php echo e($user->is_verified ? 'yellow' : 'green'); ?>-800"
                                                            title="<?php echo e($user->is_verified ? 'Unverify' : 'Verify'); ?>"
                                                            <?php if($user->role == 'admin'): ?> disabled <?php endif; ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/transamota.com/resources/views/admin/users/index.blade.php ENDPATH**/ ?>