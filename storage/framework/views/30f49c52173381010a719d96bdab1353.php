                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <?php $__currentLoopData = $favorites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $favorite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                                    <div class="relative">
                                        <?php if($primaryImage): ?>
                                            <img src="<?php echo e(asset('storage/' . $primaryImage->image_path)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-48 object-contain">
                                        <?php else: ?>
                                    ...
                                    <div class="p-4">
                                        ...
                                        <p class="text-sm text-gray-600 mt-1 truncate"><?php echo e($product->category->name ?? 'Uncategorized'); ?></p>
                                        <div class="flex items-center justify-between mt-3">
                                            <span class="font-medium text-blue-600">₹<?php echo e(number_format($product->price, 2)); ?></span>
                                            <a href="<?php echo e(route('products.show', $product)); ?>" class="text-sm text-blue-600 hover:text-blue-800">View Details</a>
                                        </div>
                                        <div class="mt-2 text-xs text-gray-500">
                                            By <?php echo e($product->seller->company_name ?? $product->seller->name); ?>
                    ...
                    <?php else: ?>
                        <div class="text-center py-12">
                            ...
                            <div class="mt-6">
                                <a href="<?php echo e(route('products.browse')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700">
                                    Browse Products
                                </a>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/transamota.com/resources/views/favorites/index.blade.php ENDPATH**/ ?>