<?php $__env->startSection('title', 'Transamota - Global B2B Trade Platform'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 text-center">
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('register')); ?>" class="inline-block px-8 py-4 bg-white text-blue-600 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors mr-4">
                        Start Selling
                    </a>
                    <a href="<?php echo e(route('products.browse')); ?>" class="inline-block px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-bold text-lg hover:bg-white hover:text-blue-600 transition-colors">
                        Browse Products
                    </a>
                <?php else: ?>
                    <?php if(Auth::user()->role === 'buyer'): ?>
                        <a href="<?php echo e(route('products.browse')); ?>" class="inline-block px-8 py-4 bg-white text-blue-600 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors mr-4">
                            Browse Products
                        </a>
                        <a href="<?php echo e(route('favorites.index')); ?>" class="inline-block px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-bold text-lg hover:bg-white hover:text-blue-600 transition-colors">
                            My Favorites
                        </a>
                    <?php elseif(Auth::user()->role === 'seller'): ?>
                        <a href="<?php echo e(route('seller.products')); ?>" class="inline-block px-8 py-4 bg-white text-blue-600 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors mr-4">
                            My Products
                        </a>
                        <a href="<?php echo e(route('seller.products.create')); ?>" class="inline-block px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-bold text-lg hover:bg-white hover:text-blue-600 transition-colors">
                            Add New Product
                        </a>
                    <?php elseif(Auth::user()->role === 'admin'): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="inline-block px-8 py-4 bg-white text-blue-600 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors mr-4">
                            Admin Dashboard
                        </a>
                        <a href="<?php echo e(route('products.browse')); ?>" class="inline-block px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-bold text-lg hover:bg-white hover:text-blue-600 transition-colors">
                            Browse Products
            ...
            <div id="quick-category-slider" class="relative">
                <div class="flex overflow-x-auto pb-4 space-x-4 hide-scrollbar">
                    <?php if($categories->count() > 0): ?>
                        ...
                        <div class="flex-shrink-0 bg-white rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow text-center min-w-[120px] cursor-pointer category-item" data-category="<?php echo e($category->id); ?>">
    ...
    <section class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-8">
                ...
                <a href="<?php echo e(route('products.browse')); ?>" class="text-blue-600 font-medium hover:text-blue-800">View All →</a>
            </div>
            
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                <?php if($products->count() > 0): ?>
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('products.show', $product->id)); ?>" class="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-md transition-shadow block">
                        ...
                        <div class="p-3">
                            ...
                            <p class="text-blue-600 font-bold text-sm">₹<?php echo e(number_format($product->price, 2)); ?></p>
                            <p class="text-gray-500 text-xs"><?php echo e($product->category->name ?? 'Category'); ?> • <?php echo e($product->created_at->diffForHumans()); ?></p>
                        </div>
                    </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/transamota.com/resources/views/welcome.blade.php ENDPATH**/ ?>