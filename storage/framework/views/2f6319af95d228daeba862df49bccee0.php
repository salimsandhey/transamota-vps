        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <nav class="flex text-sm" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2">
                    ...
                    <li>
                        <a href="<?php echo e(route('products.browse')); ?>" class="text-gray-500 hover:text-blue-600">Products</a>
                    </li>
                    <li>
                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                    ...
                    <li class="text-gray-900 truncate max-w-xs"><?php echo e($product->name); ?></li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="mb-6">
                        <?php if($product->images->count() > 0): ?>
                            ...
                            <div class="relative mb-4">
                                <img id="main-image" src="<?php echo e(\App\Helpers\ImageHelper::getImageUrl($product->images->first()->image_path)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-96 object-contain bg-white rounded-lg p-2">
                                <?php if(auth()->check()): ?>
                                <button 
                            ...
                            <div class="flex space-x-3 overflow-x-auto pb-2">
                                <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex-shrink-0">
                                        <img src="<?php echo e(\App\Helpers\ImageHelper::getImageUrl($image->image_path)); ?>" alt="<?php echo e($product->name); ?>" 
                                             class="w-20 h-20 object-cover rounded cursor-pointer border-2 <?php echo e($index === 0 ? 'border-blue-500' : 'border-gray-200'); ?> hover:border-blue-300"
                                             onclick="changeMainImage('<?php echo e(\App\Helpers\ImageHelper::getImageUrl($image->image_path)); ?>')">
                                    </div>
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-right">
                                ...
                                <div class="text-lg font-medium text-gray-900"><?php echo e($product->moq); ?> <?php echo e($product->unit); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex items-center mt-1">
                                ...
                                <span class="text-gray-900"><?php echo e($product->origin_country); ?></span>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="py-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="text-gray-900"><?php echo e($product->category->name ?? 'N/A'); ?></div>
                            </div>
                            <div>
                                <div class="text-sm text-gray-500">Subcategory</div>
                                <div class="text-gray-900"><?php echo e($product->subcategory->name ?? 'N/A'); ?></div>
                            </div>
                            <div>
                                <div class="text-sm text-gray-500">Status</div>
                                <div>
                                    <span class="px-2 py-1 rounded text-xs 
                                        <?php if($product->status == 'active'): ?> bg-emerald-100 text-emerald-800
                                        <?php elseif($product->status == 'pending'): ?> bg-amber-100 text-amber-800
                                        <?php elseif($product->status == 'inactive'): ?> bg-gray-100 text-gray-800
                                        <?php endif; ?>">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 pt-4">
                        <?php if(auth()->check()): ?>
                            <?php if(auth()->user()->role === 'buyer'): ?>
                                <button id="chat-with-seller" data-seller-id="<?php echo e($product->seller->id); ?>" data-product-id="<?php echo e($product->id); ?>" class="flex-1 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center justify-center gap-2 font-medium">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path>
                                    </svg>
                                    Chat with Seller
                                </button>
                                <button id="add-to-inquiry" data-product-id="<?php echo e($product->id); ?>" class="flex-1 px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 flex items-center justify-center gap-2 font-medium">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <?php endif; ?>
                        <?php else: ?>
                            <a href="<?php echo e(route('login', ['redirect' => url()->current()])); ?>" class="flex-1 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center justify-center gap-2 font-medium">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                            <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center">
                                <span class="text-blue-600 font-bold text-xl"><?php echo e(substr($product->seller->company_name ?? $product->seller->name ?? 'S', 0, 1)); ?></span>
                            </div>
                        </div>
                        <div class="ml-4">
                            <h4 class="font-medium text-gray-900"><?php echo e($product->seller->company_name ?? $product->seller->name ?? 'Unknown Seller'); ?></h4>
                            ...
                            <?php if($product->origin_country): ?>
                                <div class="flex items-center mt-2 text-sm text-gray-600">
                                    ...
                                    <span>From <?php echo e($product->origin_country); ?></span>
                                </div>
                            <?php endif; ?>
                            <div class="mt-3 text-sm text-gray-600">
                                <span class="font-medium text-gray-900"><?php echo e($sellerProductCount ?? 0); ?></span> products listed
                            </div>
                        </div>
                    </div>
                    <div class="mt-6">
                    ...
                    <div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                        <div class="h-48 bg-gray-100 relative">
                            <?php if($relatedProduct->images->first()): ?>
                                <img src="<?php echo e(\App\Helpers\ImageHelper::getImageUrl($relatedProduct->images->first()->image_path)); ?>" alt="<?php echo e($relatedProduct->name); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
                            ...
                            <button 
                                ...
                                title="<?php echo e(auth()->user()->favorites()->where('product_id', $relatedProduct->id)->exists() ? 'Remove from favorites' : 'Add to favorites'); ?>">
                                <svg class="w-5 h-5" viewBox="0 0 24 24">
                                    <path class="<?php echo e(auth()->user()->favorites()->where('product_id', $relatedProduct->id)->exists() ? 'text-red-500 fill-current' : 'text-gray-400 fill-current border border-red-500'); ?>" d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                                </svg>
                            </button>
                            <?php endif; ?>
                        </div>
                        <div class="p-4">
                            <h4 class="font-medium text-gray-800 mb-1 truncate"><?php echo e($relatedProduct->name); ?></h4>
                            <div class="flex items-center justify-between mt-2">
                                ...
                                <a href="<?php echo e(route('products.show', $relatedProduct->id)); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                    View
                                </a>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/transamota.com/resources/views/public/products/show.blade.php ENDPATH**/ ?>