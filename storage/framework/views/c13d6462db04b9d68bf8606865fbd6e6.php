<?php $__env->startSection('title', 'Advertise on Transamota - Promote Your Business'); ?>
                ...
                <div class="prose prose-lg max-w-none">
                    ...
                    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl p-8 text-center text-white">
                        ...
                        <div class="flex flex-col sm:flex-row justify-center gap-4">
                            <a href="<?php echo e(route('contact')); ?>?subject=Advertising Inquiry" class="px-6 py-3 bg-white text-blue-600 rounded-lg font-bold hover:bg-gray-100 transition-colors">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/transamota.com/resources/views/advertise.blade.php ENDPATH**/ ?>